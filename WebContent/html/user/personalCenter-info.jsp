            ...
            <div class="personal-center">
              <div class="personal-center-left-content">
                ...
                <div class="personal-center-control">
                  <ul class="personal-center-control-list">
                    ...
                    <li class="personal-center-control-item item-activated"><a href="personalCenter-info.jsp">个人信息</a></li>
              ...
              <div class="personal-center-right-content">
                ...
                <div class="personal-center-right-item">
                  <ul class="personal-center-info">
                    ...
                    <li class="personal-center-info-item">
                      ...
                      <p class="personal-center-info-item-item" id="password-input">******</p>
                    </li>
                ...
                <div class="personal-center-right-item-right">
                  <ul class="personal-center-info">
                    <li class="personal-center-info-item-right">
                      <input class="personal-center-info-change" id="username-change" type="text" name="" value="">
                    </li>
                    <li class="personal-center-info-item-right">
                      <input class="personal-center-info-change" type="password" name="" value=""> <p class="">原密码</p>
                      <input class="personal-center-info-change" type="password" name="" value=""> <p class="">现密码</p>
                    </li>
                    <li class="personal-center-info-item-right">
                ...
                <div class="personal-center-right-item-down">
                  <ul class="personal-center-info">
                    <li class="personal-center-info-item">
                      ...
                      <a href="#" class="personal-center-info-item-item-tech"><span id="0"
                        class="require label label-default">JAVA</span></a><a href="#"
                        class="personal-center-info-item-item-tech"><span id="0"
                        ...
                        class="personal-center-info-item-item-tech"><span id="0"
                        class="require label label-default">...</span>
                      </a>
                    </li>
                  </ul>
                </div>
