...
public class db_connector {
	...
	public boolean add_project(String name, int founder_id, String intro, String num, String time, String detail) {
		if (Integer.parseInt(num) <= 1 || Integer.parseInt(time) <= 0) return false;
		try {
			...
			update(sql);
			String pid = getSingleQuery("SELECT max(id) FROM project;");
